...
- 设计定稿见 [DESIGN_BASELINE](docs/DESIGN_BASELINE.md)；方向 / 债务 / 决策索引见 [ROADMAP](docs/ROADMAP.md)；外部依据与出处（许可证事实、行业实践惯例）见 [REFERENCES](docs/REFERENCES.md)；发布说明见 [RELEASE_NOTES](docs/RELEASE_NOTES.md)。
