...
[![Tests](https://img.shields.io/badge/tests-635%20passed-brightgreen)](#verification)
...
- **Fully procedural assets**: enemy sprites use a crystalline-prism style (dark facets + neon edges + energy cores), generated by `scripts/tools/generate_enemy_sprites.py`; SFX and BGM are synthesized by `scripts/tools/generate_audio.py`. Zero external asset dependencies.
...
godot --headless --path . res://test/smoke_test.tscn          # main flow — 115 assertions
...
godot --headless --path . res://test/elite_turret_event_test.tscn # elite turret event — 45
...
**635 assertions across 18 test scenes, all passing.**
