...
- **Volume & accessibility** — separate master / music / effects volume; flash reduction (softens hit flashes and heartbeat pulses) and screen-shake intensity (down to off) sit alongside a one-click restore of all defaults.
