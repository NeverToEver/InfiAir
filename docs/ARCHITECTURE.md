...
- Data: `data/balance.json` tunable source (top sections: version/world_scale/player/enemies/elites/boss/hud/spawner/mothership/buffs/milestones/difficulty/progression/effects/tutorial/elite_turret_event/formation_strike_event/dda); canonical Tab JSON since 2026-07-31, maintained by `balance_editor.py`. `data/translations.csv` zh/en source; `.translation` built by Godot import.
