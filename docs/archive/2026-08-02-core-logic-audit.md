...
> 状态：**已全量处置（2026-08-02，批次 1 `cb8511b` P1×3 / 批次 2 `b7b2cc8` P2×8 / 批次 3+4 `ffef641` P3+待判定 / 文档回填 `fff1b25`；2026-08-02 口径统一回填——G017/G019/G025/G031 判定不修，故措辞为「处置」而非「修复」）**。发现登记见 `docs/AUDIT_VAULT.md` G 系列（第五轮）及其「修复起效记录」；本文件为审核范围、规则、证据与修复优先级追踪单一事实源。
