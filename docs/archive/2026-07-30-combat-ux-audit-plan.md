...
**执行状态**：已完成（2026-07-30 全量实施：P0-1~P0-5、P1-1、P1-2 全部合入并提交 `fbe33e2`；全量无头回归 30 项 0 FAIL，autoplay 480s 探针 0 异常，窗口截图可读性逐项核对通过。原记「未 git commit」系执行时点快照，2026-08-02 口径统一订正；P1-3 另由 `315af0d` 于 2026-07-31 落地）。
