...
| `scripts/tools/generate_enemy_sprites.py` | `strike_carrier()` (800×460, orig 1200×700 scaled) + `turret()` (96×96), `Ship` primitives; `TURRET_WELLS` = runtime `StrikeCarrier.Sockets` 1:1. Outputs `strike_carrier.png`, `elite_turret.png` to `assets/sprites/`. |
