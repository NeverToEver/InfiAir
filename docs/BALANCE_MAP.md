...
| 行 | json 键路径 | 脚本回退值 |
| --- | --- | --- |
| 547 | `fog_events.bullet_malfunction.jitter_deg` | `20.0` |
| 548 | `fog_events.bullet_malfunction.misfire_chance` | `0.15` |
| 549 | `fog_events.bullet_malfunction.interval_jitter` | `0.3` |
| 988 | `player.aim_assist.homing_time` | `HomingTime` |
| 302 | `player.max_speed` | `MaxSpeed` |
| 303 | `player.accel` | `Accel` |
| 304 | `player.decel` | `Decel` |
| 305 | `player.boost_mult` | `BoostMult` |
| 306 | `player.fine_move_mult` | `FineMoveMult` |
| 308 | `player.base_fire_interval` | `BaseFireInterval` |
| 309 | `player.bullet_speed` | `BulletSpeed` |
| 311 | `buffs.crit_shot.chance` | `CritChanceBase` |
| 312 | `buffs.crit_shot.multiplier` | `CritMultiplier` |
| 313 | `player.bullet_spread_deg` | `BulletSpreadDeg` |
| 315 | `player.bullet_damage` | `BulletDamage` |
| 316 | `player.invincible_time` | `InvincibleTime` |
| 317 | `player.spawn_invincible_time` | `SpawnInvincibleTime` |
| 318 | `player.bullet_clear_radius` | `BulletClearRadius` |
| 320 | `player.entry.land_ratio` | `EntryLandRatio` |
| 321 | `player.entry.rush_time` | `EntryRushTime` |
| 322 | `player.entry.retreat_speed` | `EntryRetreatSpeed` |
| 323 | `player.entry.retreat_time` | `EntryRetreatTime` |
| 324 | `player.entry.invincible` | `EntryInvincible` |
| 325 | `player.entry.spawn_clearance` | `EntrySpawnClearance` |
| 326 | `player.entry.rush_hspeed_ratio` | `EntryRushHsRatio` |
| 329 | `buffs.armor.multiplier` | `ArmorMult` |
| 330 | `buffs.evasion.chance` | `EvasionChance` |
| 331 | `buffs.regen.heal_per_sec` | `RegenPerSec` |
| 332 | `effects.shake.player_hit` | `ShakeHit` |
| 336 | `player.fuel.max` | `FuelMax` |
| 339 | `player.fuel.drain` | `FuelDrain` |
| 340 | `player.fuel.regen` | `FuelRegen` |
| 341 | `player.fuel.restart` | `FuelRestart` |
| 343 | `player.dash.distance` | `DashDistance` |
| 345 | `player.dash.time` | `DashTime` |
| 349 | `player.dash.cooldown` | `DashCooldownMaxValue` |
| 350 | `player.dash.fuel_ratio` | `DashFuelRatio` |
| 351 | `player.dash.afterimage_interval` | `AfterimageInterval` |
| 353 | `player.graze_radius` | `GrazeRadius` |
| 354 | `player.graze_score` | `GrazeScore` |
| 356 | `player.parry.arc_deg` | `ParryArcDeg` |
| 357 | `player.parry.radius` | `ParryRadius` |
| 359 | `player.parry.duration` | `0.8f` |
| 360 | `player.parry.active_time` | `0.5f` |
| 361 | `player.parry.cooldown` | `3.0f` |
| 365 | `player.aim_assist.input.magnet_input_min` | `_magnetInputMin` |
| 366 | `player.aim_assist.input.magnet_input_full` | `_magnetInputFull` |
| 367 | `player.aim_assist.falloff.peak` | `_falloffPeak` |
| 368 | `player.aim_assist.falloff.end` | `_falloffEnd` |
| 369 | `player.aim_assist.falloff.min` | `_falloffMin` |
