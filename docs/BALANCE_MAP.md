...
| 行 | json 键路径 | 脚本回退值 |
| --- | --- | --- |
| 280 | `boss.hp_mults` | `[1.3, 0.7, 1.6]` |
| 288 | `boss.hp_base` | `HP_BASE` |
| 419 | `boss.enter_speed` | `ENTER_SPEED` |
| 420 | `boss.fight_y` | `FIGHT_Y` |
| 421 | `boss.strafe_min_x` | `STRAFE_MIN_X` |
| 422 | `boss.strafe_max_x` | `STRAFE_MAX_X` |
| 423 | `boss.phase2_hp_ratio` | `PHASE2_HP_RATIO` |
| 424 | `boss.enrage.hp_ratio` | `ENRAGE_HP_RATIO` |
| 425 | `boss.enrage.rate_mult` | `ENRAGE_RATE_MULT` |
| 426 | `boss.enrage.speed_mult` | `ENRAGE_SPEED_MULT` |
| 427 | `boss.enrage.player_slow` | `ENRAGE_PLAYER_SLOW` |
| 428 | `boss.enrage.snapshot_lasers` | `ENRAGE_SNAPSHOT_LASERS` |
| 429 | `boss.enrage.snapshot_ring` | `ENRAGE_SNAPSHOT_RING` |
| 430 | `boss.enrage.laser_speed` | `ENRAGE_LASER_SPEED` |
| 431 | `boss.enrage.ring_speed` | `ENRAGE_RING_SPEED` |
| 432 | `boss.enrage.duration` | `ENRAGE_DURATION` |
| 433 | `boss.enrage.transition_duration` | `ENRAGE_TRANSITION_DURATION` |
| 434 | `boss.enrage.attack_interval` | `ENRAGE_ATTACK_INTERVAL` |
| 435 | `boss.enrage.attack_windup` | `ENRAGE_ATTACK_WINDUP` |
| 436 | `boss.enrage.release_interval` | `ENRAGE_RELEASE_INTERVAL` |
| 437 | `boss.enrage.release_hold_duration` | `ENRAGE_RELEASE_HOLD_DURATION` |
| 438 | `boss.enrage.return_duration` | `ENRAGE_RETURN_DURATION` |
| 439 | `boss.enrage.path_radius_scale` | `ENRAGE_PATH_RADIUS_SCALE` |
| 441 | `boss.enrage.square_path_ratio` | `ENRAGE_SQUARE_PATH_RATIO` |
| 442 | `boss.enrage.release_laser_speed` | `ENRAGE_RELEASE_LASER_SPEED` |
| 443 | `boss.enrage.release_ring_speed` | `ENRAGE_RELEASE_RING_SPEED` |
| 445 | `boss.escape.time` | `ESCAPE_TIME` |
| 446 | `boss.escape.warning` | `ESCAPE_WARNING` |
| 447 | `boss.escape.drift` | `ESCAPE_DRIFT` |
| 448 | `boss.escape.start_speed` | `ESCAPE_START_SPEED` |
| 449 | `boss.escape.accel` | `ESCAPE_ACCEL` |
| 450 | `boss.escape.countdown_visible_from` | `ESCAPE_COUNTDOWN_FROM` |
| 451 | `boss.hp_base` | `HP_BASE` |
| 453 | `boss.strafe_speeds` | `STRAFE_SPEEDS` |
| 463 | `boss.fire_intervals` | `FIRE_INTERVALS` |
| 465 | `boss.fan_bullet_speed` | `FAN_BULLET_SPEED` |
| 466 | `boss.homing_bullet_speed` | `HOMING_BULLET_SPEED` |
| 467 | `boss.sniper_bullet_speed` | `SNIPER_BULLET_SPEED` |
| 468 | `boss.cross_bullet_speed` | `CROSS_BULLET_SPEED` |
| 469 | `boss.collision_damage` | `COLLISION_DAMAGE` |
| 470 | `buffs.slow_field.factor` | `SLOW_FIELD_FACTOR` |
| 471 | `boss.bullet_damage.fan` | `BULLET_DAMAGE_FAN` |
| 472 | `boss.bullet_damage.homing` | `BULLET_DAMAGE_HOMING` |
| 473 | `boss.bullet_damage.sniper` | `BULLET_DAMAGE_SNIPER` |
| 474 | `boss.bullet_damage.cross` | `BULLET_DAMAGE_CROSS` |
| 475 | `boss.bullet_damage.snapshot_laser` | `BULLET_DAMAGE_SNAPSHOT_LASER` |
| 476 | `boss.bullet_damage.snapshot_ring` | `BULLET_DAMAGE_SNAPSHOT_RING` |
| 477 | `boss.phases.phase_shift_duration` | `PHASE_SHIFT_DURATION` |
| 478 | `boss.phases.clear_on_shift` | `CLEAR_ON_SHIFT` |
| 479 | `boss.phases.transition_invincible` | `TRANSITION_INVINCIBLE` |
| 480 | `boss.phases.telegraph.sniper_aim` | `SNIPER_AIM_TIME` |
| 481 | `boss.phases.telegraph.sniper_track` | `SNIPER_TRACK_TIME` |
| 482 | `boss.phases.press_interval` | `PRESS_INTERVAL` |
| 483 | `boss.phases.press_depth` | `PRESS_DEPTH` |
| 484 | `boss.movement.type1_p2_strafe` | `TYPE1_P2_STRAFE` |
| 485 | `boss.movement.type1_p2_bob_amp` | `TYPE1_P2_BOB_AMP` |
| 486 | `boss.movement.type1_p2_bob_period` | `TYPE1_P2_BOB_PERIOD` |
| 487 | `boss.movement.type2_p2_dash_time` | `TYPE2_P2_DASH_TIME` |
| 488 | `boss.movement.type2_p2_rest_time` | `TYPE2_P2_REST_TIME` |
| 489 | `boss.movement.type3_p1_bob_min` | `TYPE3_P1_BOB_MIN` |
| 490 | `boss.movement.type3_p1_bob_max` | `TYPE3_P1_BOB_MAX` |
| 491 | `boss.movement.type3_p1_bob_period` | `TYPE3_P1_BOB_PERIOD` |
| 492 | `boss.movement.type3_p2_strafe` | `TYPE3_P2_STRAFE` |
| 493 | `boss.movement.type3_p2_bob_amp` | `TYPE3_P2_BOB_AMP` |
| 494 | `boss.movement.type3_p2_bob_period` | `TYPE3_P2_BOB_PERIOD` |
| 496 | `boss.phases.attacks.charged_cannon.charge` | `CANNON_CHARGE` |
| 497 | `boss.phases.attacks.charged_cannon.shots` | `CANNON_SHOTS` |
| 498 | `boss.phases.attacks.charged_cannon.interval` | `CANNON_INTERVAL` |
| 499 | `boss.phases.attacks.charged_cannon.bullet_speed` | `CANNON_BULLET_SPEED` |
| 500 | `boss.phases.attacks.charged_cannon.damage` | `CANNON_DAMAGE` |
| 501 | `boss.phases.attacks.charged_cannon.flash` | `CANNON_FLASH` |
| 502 | `boss.phases.attacks.dash_sweep.aim` | `SWEEP_AIM` |
| 503 | `boss.phases.attacks.dash_sweep.speed` | `SWEEP_SPEED` |
| 504 | `boss.phases.attacks.dash_sweep.drop_count` | `SWEEP_DROP_COUNT` |
| 505 | `boss.phases.attacks.dash_sweep.drop_speed` | `SWEEP_DROP_SPEED` |
| 506 | `boss.phases.attacks.dash_sweep.drop_damage` | `SWEEP_DROP_DAMAGE` |
| 507 | `boss.phases.attacks.dash_sweep.return_duration` | `SWEEP_RETURN_DURATION` |
| 508 | `boss.phases.attacks.minion_volley.count` | `VOLLEY_COUNT` |
| 509 | `boss.phases.attacks.minion_volley.delay` | `VOLLEY_DELAY` |
| 510 | `boss.phases.attacks.minion_volley.bullet_speed` | `VOLLEY_BULLET_SPEED` |
| 511 | `boss.phases.attacks.minion_volley.bullet_damage` | `VOLLEY_BULLET_DAMAGE` |
| 512 | `boss.phases.attacks.bullet_wall.count` | `WALL_COUNT` |
| 513 | `boss.phases.attacks.bullet_wall.bullet_speed` | `WALL_BULLET_SPEED` |
| 514 | `boss.phases.attacks.bullet_wall.damage` | `WALL_DAMAGE` |
| 515 | `boss.phases.attacks.bullet_wall.arc_deg` | `WALL_ARC_DEG` |
| 517 | `boss.enrage.type_1.ring_interval` | `E1_RING_INTERVAL` |
| 518 | `boss.enrage.type_1.ring_count` | `E1_RING_COUNT` |
| 519 | `boss.enrage.type_1.ring_speed` | `E1_RING_SPEED` |
| 520 | `boss.enrage.type_1.ring_precession_deg` | `E1_RING_PRECESSION_DEG` |
| 521 | `boss.enrage.type_1.salvo_charge` | `E1_SALVO_CHARGE` |
| 522 | `boss.enrage.type_1.salvo_count` | `E1_SALVO_COUNT` |
| 523 | `boss.enrage.type_1.salvo_speed` | `E1_SALVO_SPEED` |
| 524 | `boss.enrage.type_1.salvo_damage` | `E1_SALVO_DAMAGE` |
| 525 | `boss.enrage.type_2.point_count` | `E2_POINT_COUNT` |
| 526 | `boss.enrage.type_2.point_interval` | `E2_POINT_INTERVAL` |
| 527 | `boss.enrage.type_2.aim` | `E2_AIM` |
| 528 | `boss.enrage.type_2.sniper_speed` | `E2_SNIPER_SPEED` |
| 529 | `boss.enrage.type_2.sniper_damage` | `E2_SNIPER_DAMAGE` |
| 530 | `boss.enrage.type_2.release_ring_count` | `E2_RELEASE_RING_COUNT` |
| 531 | `boss.enrage.type_2.release_ring_speed` | `E2_RELEASE_RING_SPEED` |
| 532 | `boss.enrage.type_3.summon_interval` | `E3_SUMMON_INTERVAL` |
| 534 | `boss.phases.type3.summon_interval` | `_summon_interval` |
| 536 | `boss.enrage.type_3.summon_waves` | `E3_SUMMON_WAVES` |
| 537 | `boss.enrage.type_3.summon_count` | `E3_SUMMON_COUNT` |
| 538 | `boss.enrage.type_3.ring_interval` | `E3_RING_INTERVAL` |
| 539 | `boss.enrage.type_3.ring_count` | `E3_RING_COUNT` |
| 540 | `boss.enrage.type_3.ring_speed` | `E3_RING_SPEED` |
| 541 | `boss.enrage.type_3.release_ring_count` | `E3_RELEASE_RING_COUNT` |
| 542 | `boss.enrage.type_3.release_ring_speed` | `E3_RELEASE_RING_SPEED` |
| 544 | `boss.difficulty_scaling.interval_mult` | `DIFF_INTERVAL_MULT` |
| 545 | `boss.difficulty_scaling.speed_mult` | `DIFF_SPEED_MULT` |
| 546 | `boss.difficulty_scaling.counts` | `DIFF_COUNT_DELTAS` |
| 772 | `effects.shake.enrage` | `16.0` |
| 924 | `effects.shake.enrage` | `16.0` |
...
| 732 | `player.aim_assist.homing_time` | `HOMING_TIME` |
...
| 行 | json 键路径 | 脚本回退值 |
| --- | --- | --- |
| 750 | `milestones.boss_kill_base` | `500.0` |
...
| 801 | `buffs.lifesteal.max_hp_fraction` | `0.1` |
| 1302 | `player.aim_assist.joy_speed` | `joy_aim_speed` |
