...
STEPS = (
    ...
    {"slug": "smoke", "name": "无头冒烟二十二趟（主场景/设置页/编队/精英炮塔/死亡打断/燃料满扫/手感/难度曲线/迷雾/迷雾打断/返航宽限/Boss阶段机/母舰坞态/遭遇击杀型/恶意存档/死亡删档门控/增幅缓存复用/存档还原/设置版本回退/提前离舰蓄力/教程场景/自动游玩全周期）", "kind": "bash", "script": "check_smoke.sh", "godot": True},
