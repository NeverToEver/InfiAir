...
- CI/CD changes: reviewable workflows + release notes first, then sync the entry docs + `release.sh`; no 3rd-party deps beyond official checkout action + Godot binary/templates.
