...
func _ready() -> void:
	...
	_check(GameState.cfg("mothership.depart_cooldown", 0.0) == 90.0, "母舰冷却 90s")
	...
	_check(GameState.cfg("buffs.slow_field.factor", 0.0) == 0.6, "慢速力场减速 0.6")
