...
public partial class ReturnCapture : Node
{
    ...
    {
        (3.2, System.IO.Path.GetTempPath() + "return_shot1.png"),
        (11.2, System.IO.Path.GetTempPath() + "return_shot2.png"),
        (19.2, System.IO.Path.GetTempPath() + "return_shot3.png"),
        (27.2, System.IO.Path.GetTempPath() + "return_shot4.png"),
        (39.7, System.IO.Path.GetTempPath() + "return_shot5.png"),
        (43.2, System.IO.Path.GetTempPath() + "return_shot6.png"),
        (54.6, System.IO.Path.GetTempPath() + "return_shot7.png"),
        (55.9, System.IO.Path.GetTempPath() + "return_shot8.png"),
    };
