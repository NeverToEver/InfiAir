...
public partial class SummonCapture : Node
{
    ...
    private async Task RunAsync()
    {
        try
        {
            ...
            await Shot(System.IO.Path.GetTempPath() + "summon_window_charge.png");
            ...
            await Shot(System.IO.Path.GetTempPath() + "summon_hangar1.png");
            await Coroutine.WaitSeconds(this, 0.8);  // 镜头 2 中段（维护臂收回）
            await Shot(System.IO.Path.GetTempPath() + "summon_hangar2.png");
            await Coroutine.WaitSeconds(this, 0.6);  // 镜头 3 中段（弹射出仓）
            await Shot(System.IO.Path.GetTempPath() + "summon_hangar3.png");
            ...
            await Shot(System.IO.Path.GetTempPath() + "summon_gate.png");

            // ---------- 4. DOCKING 牵引光束（流环/描边/尘粒 + 火力掩护） ----------
            await Coroutine.WaitSeconds(this, 1.05);  // DESCEND 剩余 + DOCKING 前 0.4s
            await Shot(System.IO.Path.GetTempPath() + "summon_docking.png");
            ...
            await Shot(System.IO.Path.GetTempPath() + "summon_docked.png");
