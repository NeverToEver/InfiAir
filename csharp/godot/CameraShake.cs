...
/// 迁移期：GameState 为 GDScript autoload，signal 经 Connect("screen_shake") 连接
...
public partial class CameraShake : Camera2D
{
    ...
    public override void _Ready()
    {
        ...
        if (gs != null && !gs.IsConnected("screen_shake", _onShake))
        {
            gs.Connect("screen_shake", _onShake);
        }
    ...
    public override void _ExitTree()
    {
        ...
        if (gs != null && gs.IsConnected("screen_shake", _onShake))
        {
            gs.Disconnect("screen_shake", _onShake);
        }
    }
