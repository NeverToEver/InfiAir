...
/// BalanceService ramp 转发簇经构造注入（_balanceService）。门面转发先例：与
/// MissionsService 同构——GameState 组合持有本服务，GameState.Difficulty.cs 为
...
/// 顺序与拆域前逐位一致；AddBossKill 的难度信号由 GameState 侧直发，不经本事件）。
/// </summary>
public sealed partial class RunProgressionService : RefCounted
{
    ...
    /// <summary>M6（2026-08-10 审计）：难度倍率缓存——Difficulty 是公开属性，直写不经
